...
void testeBoladoEBC(int mode)
{
	...
	encrypt(inputData, 32, originalKey, result, 10, EBC, NULL,mode);
...
void testeBoladoCBC(int mode)
{
	...
	encrypt(inputData, 32, originalKey, result, 10, CBC, iv,mode);
...
void testeBoladoEBCDecrypt()
{
	...
	decrypt(inputData, 16, originalKey, result, 10, EBC, NULL,DECRYPT);
}
...
void testeBoladoCBCDecrypt()
{
	...
	decrypt(inputData, 32, originalKey, result, 10, CBC, iv, DECRYPT);
}
